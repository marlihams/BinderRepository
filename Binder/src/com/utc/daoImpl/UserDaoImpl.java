...
public class UserDaoImpl implements UserDao {
	...
	private static final String SQL_SELECT_BY_EMAIL ="SELECT u.userId,u.telephone,u.dateCreation,u.addresse,u.username,u.password,u.email,u.status FROM projetJEE.user u,  where u.email = ? ;";
	private static final String SQL_SELECT_BY_ID = "SELECT userId,username,password,email,dateCreation,telephone,addresse,status FROM projetJEE.user FROM projetJEE.user where userId = ?;";
	private static final String SQL_SELECT_BY_USERNAME = "SELECT userId,username,password,email,dateCreation,telephone,addresse,status FROM projetJEE.user where username= ?;";
	private static final String SQL_INSERT_FUTURE_USER = "INSERT INTO projetJEE.inscription (`username`, `password`, `email`, `dateCreation`, `telephone`, `addresse`, `status`) VALUES (?,?, ?, ?, ?, ?, ?);";
	private static final String SQL_INSERT_USER_ROLE = "INSERT INTO projetJEE.usersandroles (`userId`, `roleId`) values(?,?);";
	private static final String SQL_SELECT_ALL = "SELECT userId,username,password,email,dateCreation,telephone,addresse FROM projetJEE.user;";
	private static final String SQL_SELECT_ALL_FUTURE_USER = "SELECT userId,username,password,email,dateCreation,telephone,addresse,status FROM projetJEE.inscription;";
	...
	private static final String SQL_DESACTIVE_ROLE_USER= "delete  from projetJEE.usersandroles  where `userId`=? and roleId=?; ";
	...
	private static final String SQL_SELECT_FUTURE_USER = "SELECT userId,username,password,email,dateCreation,telephone,addresse,status FROM projetJEE.inscription where email=?;";
	private static final String SQL_INSERT_USER ="INSERT INTO projetJEE.user (`username`, `password`, `email`, `dateCreation`, `telephone`, `addresse`, `status`) VALUES (?,?, ?, ?, ?, ?, ?);";
	private static final String SQL_DELETE_FUTURE_USER ="delete  from projetJEE.inscription where email=?";
	private static final String SQL_DELETE_USER=""; // NON ECRIT NE PAS OUBLIER LEFFET DES CLES ETRANGERES 
	public UserDaoImpl(DAOFactory daoFactory) {
		this.daoFactory = daoFactory;
	}
	
	@Override
	public boolean create(User user,boolean type) throws DAOException {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		ResultSet autogeneratedResultSet = null;
		boolean success=false;
		String requete=type?SQL_INSERT_USER: SQL_INSERT_FUTURE_USER;
		try {
			connection = daoFactory.getConnection();
			preparedStatement = initializePreparedStatement(connection,
					requete, true,user.getUsername(), user.getPassword(), user.getEmail(),
	...
	@Override
	public User findByEmail (String email,boolean type) throws DAOException {
		
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		User user = null;
		String requete=type?SQL_SELECT_BY_EMAIL:SQL_SELECT_FUTURE_USER;
		try {
	...
	@Override
	public List<User> findAllUsers(boolean type) throws DAOException {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
		ResultSet resultSet = null;
		User user = null;
		String requete=type?  SQL_SELECT_ALL : SQL_SELECT_ALL_FUTURE_USER;
	...
	@Override
	public boolean deleteUser(String email,boolean type) throws DAOException {
		Connection connection = null;
		PreparedStatement preparedStatement = null;
	boolean succes=false;
		User user = null;
		String requete=type ? SQL_DELETE_USER :SQL_DELETE_FUTURE_USER;
		try {
			connection = daoFactory.getConnection();
			preparedStatement = initializePreparedStatement(connection,
					requete,false,email);
